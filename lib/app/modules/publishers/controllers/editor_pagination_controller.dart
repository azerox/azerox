...
abstract class EditorPaginationController<T> extends ValueNotifier<PaginationState<T>> {
  EditorPaginationController() : super(PaginationState.empty<T>());
  ...
  void removeItemById(int itemId) {
    ...
    newList?.removeWhere((chapter) => (chapter as dynamic).codUserFriend == itemId);
