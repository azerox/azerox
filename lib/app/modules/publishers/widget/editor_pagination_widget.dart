...
class EditorPaginationWidget<T> extends StatefulWidget {
  ...
  @override
  State<EditorPaginationWidget<T>> createState() => _EditorPaginationWidgetState<T>();
}

class _EditorPaginationWidgetState<T> extends State<EditorPaginationWidget<T>> {
  @override
  void initState() {
    super.initState();
