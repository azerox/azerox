...
abstract class UserPaginationController<T> extends ValueNotifier<PaginationState<T>> {
  UserPaginationController() : super(PaginationState.empty<T>());
  ...
  void removeItemById(int itemId) {
    ...
    newList?.removeWhere((chapter) => (chapter as dynamic).codUser == itemId);
