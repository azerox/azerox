...
class UserPaginationWidget<T> extends StatefulWidget {
  final UserPaginationController<T> controller;
  ...
  @override
  State<UserPaginationWidget<T>> createState() => _UserPaginationWidgetState<T>();
}

class _UserPaginationWidgetState<T> extends State<UserPaginationWidget<T>> {
  @override
  void initState() {
    super.initState();
