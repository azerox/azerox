...
class SpecificImageSourceWidget extends StatefulWidget {
  const SpecificImageSourceWidget({Key? key}) : super(key: key);

  @override
  State<SpecificImageSourceWidget> createState() => _SpecificImageSourceWidgetState();
}

class _SpecificImageSourceWidgetState extends State<SpecificImageSourceWidget> {
